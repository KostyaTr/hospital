...
<ul>
    ...
    <li><a href="${pageContext.request.contextPath}/personalAccount">Personal Account</a></li>
...
<form action="${pageContext.request.contextPath}/personalDoctor/createTreatmentCourse" method="post">
    ...
    <label for="receptionDesc">Reception Description</label>
    <input type="text" id="receptionDesc" name="receptionDesc"><br/>
