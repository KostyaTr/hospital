...
public class DefaultPatientDaoTest {
    ...
    static void insert() throws SQLException {
        ...
        final String sqlPatient = "insert into patient values(1, 1, 1, 1, 1, '2020-04-08');";

        try(Connection connection = DataSource.getInstance().getConnection()) {
            PreparedStatement preparedStatement = connection.prepareStatement("delete from patient where 1=1");
    ...
    @Test
    void getPatients(){
        assertFalse(patientDao.getPatients().isEmpty());
    }
    @Test
    void getPatientById(){
        assertNotNull(patientDao.getPatientById((long) 1));
        assertNull(patientDao.getPatientById((long) 2));
    }
    @Test
    void addPatient(){
        assertNotNull(patientDao.addPatient(new Patient((long)2, (long)1, (long)1, (long)1, (long)1, new Date())));
    }

    @Test
    void getPatientsByDoctorId(){
        assertTrue(patientDao.getPatientsByDoctorId((long) 2).isEmpty());
        assertFalse(patientDao.getPatientsByDoctorId((long) 1).isEmpty());
    }
